...
Peta::Peta(){
	// petaSumatra = new Garis[6];
	// petaJawa = new Garis[5];
	// petaSulawesi = new Garis[13];
	// petaKalimantan = new Garis[8];		
}
Peta::~Peta(){

}
void Peta::gambarPeta(int y, Buffer buff,Warna putih){
	  pulauSumatra(y,buff, putih);
	  pulauJawa(y,buff, putih);
	  pulauKalimantan(y,buff, putih);
	  pulauSulawesi(y,buff, putih);
}
...
Garis* Peta::getPetaSumatra(){
	return petaSumatra;
}

Garis* Peta::getPetaJawa(){
	return petaJawa;
}

Garis* Peta::getPetaKalimantan(){
	return petaKalimantan;
}

Garis* Peta::getPetaSulawesi(){
	return petaSulawesi;
}


void Peta::pulauSumatra(int y, Buffer buff, Warna putih){
...
void Peta::pulauJawa(int y, Buffer buff, Warna putih){
...
void Peta::pulauKalimantan(int y, Buffer buff, Warna putih){
...
void Peta::pulauSulawesi(int y, Buffer buff, Warna putih){
